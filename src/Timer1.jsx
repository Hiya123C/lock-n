...
export default function Timer({ taskState, addCoins, spendCoins, onCameraReady, onStatusChange }) {
  ...
  const faceDetection = useFaceDetection({
    ...
    onPenalty: () => { spendCoins(100); setAbsenceMode("penalty") },
    ...
    <div className="timer-wrapper">
      ...
      {finished && (
        <div className="finished">
          <p className="finish-msg">session completed!</p>
          <p className="finish-sub">
            {coinsEarned > 0 ? `you earned ${coinsEarned} coins!` : "less than 50% of goals completed, no coins this time :("}
          </p>
